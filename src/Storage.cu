...
void Storage::print_VTK_File(void) {
	...
	if ((SYSTEM)) {
		...
		std::string initial = "Animation_realistic/YB_cellwall3_l0d5b0d05a0d1_detgrowth_strain0d2_maxt400_esfreq200_longsim400_";
...
void Storage::storeVariables(void) {
	...
	if (SYSTEM) {
		...
		std::string initial = "Variables_realistic/YB_cellwall3_l0d5b0d05a0d1_detgrowth_strain0d2_maxt400_esfreq200_longsim400_";
		//std::string initial = "Animation_realistic_flow/Pflow0d5_v0d0005_MRT0d005_dt0d0002_";
		std::ofstream ofs;
		if (digits == 1 || digits == 0) {
